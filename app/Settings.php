...
class Settings
{
	...
	public function publishDocuments(): void
	{
		...
		if (
			// phpcs:ignore WordPress.Security.NonceVerification.Recommended
			isset($_GET['pccGrant'], $_GET['publishingLevel']) &&
			// phpcs:ignore WordPress.Security.NonceVerification.Recommended
	 ...
	 * @return void
	 */
	public function registerPantheonCloudStatusEndpoint(): void
	{
		global $wp;
	 ...
	 * @return void
	 */
	public function pluginAdminNotice(): void
	{
		global $pagenow;
	 ...
	 * @return void
	 */
	public function pluginNotification(): void
	{
	 ...
	 */
	public function overrideAdminWPPostsTable(string $className): string
	{
