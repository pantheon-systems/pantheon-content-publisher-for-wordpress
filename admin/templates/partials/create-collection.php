		...
		<div class="create-collection-page">
			<div class="page-grid">
				<div class="col-span-7 justify-self-start">
					<h1 class="page-header mt-[1.875rem]"><?php esc_html_e('Create your first content collection', PCC_HANDLE) ?></h1>
					<p class="page-description mb-8"><?php esc_html_e('Just one more step! A content collection is a set of content for your WordPress site. Connected to Google Workspace, it helps you organize and manage your site content in Google Docs.', PCC_HANDLE) ?></p>
					<p class="text-with-border mb-[1.875rem]"><?php echo esc_url(site_url()) ?></p>
					<p class="text-lg font-bold mb-[1.25rem]" ><?php esc_html_e('Publish your document as:', PCC_HANDLE) ?></p>
